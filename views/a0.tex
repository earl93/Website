...
\begin{tikzpicture}
		...
		\draw[thick,]  (7,1) node {\textbullet (7,1)};
...
\begin{tabular}{ c c }
	\includegraphics[scale=0.5]{polar_bear.jpg} &%your
	\includegraphics[scale=0.5]{whales.jpg} &
	\includegraphics[scale=0.5]{turtles.jpg} &%your
	\includegraphics[scale=0.5]{Lions.jpg} &%your
			%yourimage\\ 
