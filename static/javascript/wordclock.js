$(document).ready(function() {
	...
	content+="<li id='wc-m0'>o'clock</li>";
	content+="<li id='wc-m1'>oh-one</li>";
	content+="<li id='wc-m2'>oh-two</li>";
	content+="<li id='wc-m3'>oh-three</li>";
	content+="<li id='wc-m4'>oh-four</li>";
	content+="<li id='wc-m5'>oh-five</li>";
	content+="<li id='wc-m6'>oh-six</li>";
	content+="<li id='wc-m7'>oh-seven</li>";
	content+="<li id='wc-m8'>oh-eight</li>";
	content+="<li id='wc-m9'>oh-nine</li>";
	...
	content+="<li id='wc-s0'>zero</li>";
	content+="<li id='wc-s1'>one</li>";
	content+="<li id='wc-s2'>two</li>";
	content+="<li id='wc-s3'>three</li>";
	content+="<li id='wc-s4'>four</li>";
	content+="<li id='wc-s5'>five</li>";
	content+="<li id='wc-s6'>six</li>";
	content+="<li id='wc-s7'>seven</li>";
	content+="<li id='wc-s8'>eight</li>";
	content+="<li id='wc-s9'>nine</li>";
